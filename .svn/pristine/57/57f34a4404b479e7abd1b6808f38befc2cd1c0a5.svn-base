...
public class StoreController {
	 ...
	 * 显示页面的方法
	 */
	@MethodAnnotation(name = "主页", type = ResourceType.用户店铺)
	 ...
	 * 获取所有店铺
	 */
	@MethodAnnotation(name = "列表", type = ResourceType.用户店铺)
	 ...
	 * 查询店铺
	 */
	@MethodAnnotation(name = "查询", type = ResourceType.用户店铺)
	 ...
	 * 审核成功
	 */
	@MethodAnnotation(name = "审核通过", type = ResourceType.用户店铺)
	@RequestMapping("/success")
	@ResponseBody
	public AjaxResult success(Long id) {
		AjaxResult ar;
		try {
			storeService.success(id);
			ar = new AjaxResult();
	 ...
	 * 审核失败
	 */
	@MethodAnnotation(name = "审核拒绝", type = ResourceType.用户店铺)
	@RequestMapping("/failure")
	@ResponseBody
	public AjaxResult failure(Long id,String remark) {
		AjaxResult ar;
		try {
			storeService.failure(id,remark);
			ar = new AjaxResult();
		} catch (LogicException e) {
			ar = new AjaxResult(e.getMessage(), e.getErrorCode());
		}
	 ...
	 * 停用
	 */
	@MethodAnnotation(name = "停用", type = ResourceType.用户店铺)
	@RequestMapping("/leave")
	@ResponseBody
	public AjaxResult leave(Long id,String remark) {
		AjaxResult ar;
		try {
			storeService.leave(id,remark);
			ar = new AjaxResult();
		} catch (LogicException e) {
			ar = new AjaxResult(e.getMessage(), e.getErrorCode());
		}
	 ...
	 * 获取认证信息
	 */
	@MethodAnnotation(name = "认证信息", type = ResourceType.用户店铺)
