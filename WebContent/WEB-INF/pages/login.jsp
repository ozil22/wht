...
<div class="page-container">
	<div class="main_box">
			...
			<div class="login_form">
				<form class="easyui-form" id="login_form" method="post">
					<div class="form-group">
						...
						<input id="name" value="admin" name="username" type="text" class="form-control x319 in" 
						autocomplete="off">
					</div>
					<div class="form-group">
						<label for="j_password" class="t">密　码：</label> 
						<input id="password" value="admin" name="password" type="password" 
		...
		<div class="bottom">微货通后台 &copy; 2015 - 2025 <a href="#">系统登陆</a></div>
	</div>
</div>
