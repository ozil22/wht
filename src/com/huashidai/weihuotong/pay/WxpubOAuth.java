...
public class WxpubOAuth {
    ...
    public static String getOpenId(String appId, String appSecret, String code)
    	...
    	String httpGet = WxpubOAuth.httpGet(code);
    	System.out.println("=-------------------------------------------------------");
     ...
     */
    public static String createOauthUrlForCode(String appId, String redirectUrl, boolean moreInfo,String chargeParam)
            throws UnsupportedEncodingException {
        ...
        sb.append("&state=").append(chargeParam);
