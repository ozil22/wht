...
public interface GoodsMapper {
	...
	void delete(Long id);
	/**
	 * 获取单个(包含关联对象Store,brand,type,bannerImage,detailsImages)
	 * @param id
	 * @return
	 */
	...
	Goods get(Long id);
	/**
	 * 查询所有(包含关联对象Store,brand,type,bannerImage,detailsImages)
	 */
	List<Goods> getAll();
	/**
	 * 高级查询(包含关联对象Store,brand,type,bannerImage,detailsImages)
	 */
